...
image, draw = base("THE PROBLEM", 1)
text(draw, (62, 230), "PAYING BEFORE SEEING", 60, bold=True)
text(draw, (62, 304), "PUTS THE RISK ON ME.", 60, fill=PURPLE, bold=True)
wrapped(draw, (66, 414), "Fund one outcome instead of buying attempts or sorting through prompt spam.", 27, 800)
draw.rectangle((950, 146, 1220, 518), fill=DARK)
text(draw, (1085, 270), "RESULT", 50, fill=ACID, bold=True, anchor="mm")
text(draw, (1085, 330), "BEFORE PAYMENT", 14, fill="#a9aca2", bold=True, anchor="mm", mono=True)
draw.rectangle((980, 406, 1190, 468), fill=ACID)
text(draw, (1085, 438), "LESS RISK", 17, bold=True, anchor="mm")
...
text(draw, (W // 2, 458), "outcome-ausd-spark.shuto-kajita.chatgpt.site", 16, fill=MUTED, bold=True, anchor="mm", mono=True)
